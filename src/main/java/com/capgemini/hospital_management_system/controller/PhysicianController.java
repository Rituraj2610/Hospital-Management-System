...
public class PhysicianController {
    ...
    public ResponseEntity<Response<PhysicianDto>> getPhysicianByName(@PathVariable String name) {
        Physician physician = physicianRepository.findByName(name)
                .orElseThrow(() -> new EntityNotFoundException("Physician not found with name: " + name));
        ...
        Response<PhysicianDto> response = Response.<PhysicianDto>builder()
                ...
                .message("Physician found successfully")
                .data(physicianDto)
    ...
    // PUT /physician/update/name/{empid}?newName=XYZ
    ...
    // PUT /physician/update/ssn/{empid}?newSsn=XXXX
